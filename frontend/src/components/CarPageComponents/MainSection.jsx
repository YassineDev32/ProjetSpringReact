      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className={`p-2 rounded ${isGridView ? "bg-blue-500 text-white" : "bg-gray-300"}`}
          >
        ...
        {filteredCars.map((car) => (
          <div key={car.id} className="bg-white rounded-lg shadow-2xl p-6 flex flex-col justify-between hover:shadow-gray-400 transition duration-300">
            ...
            <div className="text-center mt-4">
              <h3 className="text-2xl font-semibold truncate max-[500px]:text-xl text-black">{car.carName}</h3>
            </div>
            ...
            <div className="mt-4 text-center">
              <p className="text-3xl text-gray-800 mb-5 font-bold">{car.price} MAD/Jour</p>
            </div>
